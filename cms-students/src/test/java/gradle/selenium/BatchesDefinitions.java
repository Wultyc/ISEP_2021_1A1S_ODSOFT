...
public class BatchesDefinitions implements SeleniumCucumber {
    ...
    @Then("^Save Batch$")
    public void save_Batch() throws Throwable {
        Thread.sleep(3000);
    ...
    @Then("^Delete Batch$")
    public void delete_Batch() throws Throwable {
        Thread.sleep(3000);
        List<WebElement> list = driver.findElements(By.xpath("/html/body/div[4]/div[2]/div/div[4]/div/div[3]/div/div[2]/div/div[2]/div/div[2]/div/div[3]/div/div/table/tbody/tr/td/table/tbody/tr[2]/td[2]/div/table/tbody/tr[2]/td/table"));
        Assert.assertFalse(definitionObj.find(list, "Batch_Name_X_Testing_Edit: Description_Y_Testing_Edit"));
        //driver.close();
    }
    ...
    @Then("^Edit Batch$")
    public void edit_Batch() throws Throwable {
        Thread.sleep(2000);
        List<WebElement> list = driver.findElements(By.xpath("/html/body/div[4]/div[2]/div/div[4]/div/div[3]/div/div[2]/div/div[2]/div/div[2]/div/div[3]/div/div/table/tbody/tr/td/table/tbody/tr[2]/td[2]/div/table/tbody/tr[2]/td/table"));
