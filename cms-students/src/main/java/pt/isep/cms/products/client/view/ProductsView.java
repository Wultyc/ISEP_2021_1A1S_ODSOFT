...
public class ProductsView extends Composite implements ProductsPresenter.Display {
	private final Button addButton;
	private final Button deleteButton;
	private FlexTable productsTable;
	...
	public ProductsView() {
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "products-ListContainer");
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "products-ListMenu");
		...
		productsTable.addStyleName("products-ListContents");
		productsTable.getColumnFormatter().setWidth(0, "15px");

		// vPanel.add(productsTable);
	...
	public void setData(List<String> data) {
		...
		for (int i = 0; i < data.size(); ++i) {
			productsTable.setWidget(i, 0, new CheckBox());
			productsTable.setText(i, 1, data.get(i));
		}
	}
