 ...
 * the License.
 */
package pt.isep.cms.products.client.view;
 ...
 */
public class ProductsDialog implements EditProductPresenter.Display {
	...
	public static interface CwConstants extends Constants {
		...
		String cwAddProductDialogCaption();
		
		String cwUpdateProductDialogCaption();
...
//		String cwDialogBoxShowButton();
	...
	private void initDetailsTable() {
		detailsTable.setWidget(0, 0, new Label("Product Name"));
	 ...
	 *            the constants
	 */
	public ProductsDialog(ShowcaseConstants constants, Type type) {
		...
		detailsTable.addStyleName("products-ListContainer");
		detailsTable.getColumnFormatter().addStyleName(1, "add-product-input");
		name = new TextBox();
		descrip = new TextBox();
		price = new TextBox();
		initDetailsTable();
		...
		if (type==Type.ADD)
			dialogBox.setText(constants.cwAddProductDialogCaption());
		else 
			dialogBox.setText(constants.cwUpdateProductDialogCaption());
