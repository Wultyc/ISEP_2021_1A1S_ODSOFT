...
public class WarehousesView extends Composite implements WarehousesPresenter.Display {
	...
	public WarehousesView() {
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "warehouses-ListContainer");
		...
		contentTable.getCellFormatter().addStyleName(0, 0, "warehouses-ListMenu");
		...
		warehousesTable.addStyleName("warehouses-ListContents");
		warehousesTable.getColumnFormatter().setWidth(0, "15px");

		// vPanel.add(warehousesTable);
