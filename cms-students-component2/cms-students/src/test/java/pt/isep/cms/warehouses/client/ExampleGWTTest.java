...
public class ExampleGWTTest extends GWTTestCase {
	...
	public void testWarehouseSort() {
		...
		warehouseDetails.add(new WarehouseDetails("0", "Warehouse A"));
		warehouseDetails.add(new WarehouseDetails("1", "Warehouse B"));
		warehouseDetails.add(new WarehouseDetails("2", "Warehouse C"));
		warehousesPresenter.setWarehouseDetails(warehouseDetails);
		warehousesPresenter.sortWarehouseDetails();
		assertTrue(warehousesPresenter.getWarehouseDetail(0).getDisplayName().equals("Warehouse A"));
		assertTrue(warehousesPresenter.getWarehouseDetail(1).getDisplayName().equals("Warehouse B"));
		assertTrue(warehousesPresenter.getWarehouseDetail(2).getDisplayName().equals("Warehouse C"));
	}
